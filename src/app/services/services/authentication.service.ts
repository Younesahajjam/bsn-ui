...
import { registre } from '../fn/authentication/registre';
import { Registre$Params } from '../fn/authentication/registre';
...
export class AuthenticationService extends BaseService {
  ...
  static readonly RegistrePath = '/auth/register';
   ...
   */
  registre$Response(params: Registre$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registre(params: Registre$Params, context?: HttpContext): Observable<{
}> {
